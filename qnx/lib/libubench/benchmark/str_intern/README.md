...
| Metric                      |       none | forward_list |         set | unordered_set | fixed_set_128k | fixed_set_256k | fixed_set_512k | fixed_set_1m |    var_set |
| --------------------------- | ---------: | -----------: | ----------: | ------------: | -------------: | -------------: | -------------: | -----------: | ---------: |
...
| Currently Allocated (bytes) |          8 |   13,748,928 |  21,851,384 |    19,258,264 |     22,899,976 |     23,948,552 |     26,045,704 |   30,240,008 | 26,045,728 |
| Max Allocated Mem (bytes)   |          8 |   13,748,928 |  21,851,475 |    19,258,339 |     22,899,976 |     23,948,552 |     26,045,704 |   30,240,008 | 26,045,728 |
| Total Allocated Mem (bytes) |          8 |   13,748,928 | 758,821,533 |   574,800,861 |     22,899,976 |     23,948,552 |     26,045,704 |   30,240,008 | 42,691,872 |
| Total Freed Mem (bytes)     |          0 |            0 | 736,970,149 |   555,542,597 |              0 |              0 |              0 |            0 | 16,646,144 |
| Allocation Count            |          1 |      350,176 |  11,876,595 |    11,876,610 |        687,779 |        687,779 |        687,779 |      687,779 |  1,207,978 |
| Free Count                  |          0 |            0 |  11,426,419 |    11,526,433 |              0 |              0 |              0 |            0 |    520,199 |
| Process Time (ms)           |        407 |   16,177,978 |       4,352 |         1,507 |          1,155 |            992 |            907 |          871 |      1,046 |
| System Time (ms)            |        464 |   16,558,119 |       4,508 |         1,591 |          1,234 |          1,059 |          1,006 |          940 |      1,185 |
| Elapsed Time (ms)           |        408 |   16,180,343 |       4,352 |         1,507 |          1,155 |            992 |            907 |          871 |      1,046 |
...
| Words                       | 11,847,228 |   11,847,228 |  11,847,228 |    11,847,228 |     11,847,228 |     11,847,228 |     11,847,228 |   11,847,228 | 11,847,228 |
| Interned Words              |          0 |      337,601 |     337,601 |       337,601 |        337,601 |        337,601 |        337,601 |      337,601 |    337,601 |
| Currently Allocated (bytes) |          8 |   10,840,328 |  18,942,760 |    16,833,376 |     19,991,376 |     21,039,952 |     23,137,104 |   27,331,408 | 23,137,128 |
| Max Allocated Mem (bytes)   |          8 |   10,840,328 |  18,942,848 |    16,833,448 |     19,991,376 |     21,039,952 |     23,137,104 |   27,331,408 | 23,137,128 |
| Total Allocated Mem (bytes) |          8 |   10,840,328 | 663,581,680 |   480,609,784 |     19,991,376 |     21,039,952 |     23,137,104 |   27,331,408 | 39,783,272 |
| Total Freed Mem (bytes)     |          0 |            0 | 644,638,920 |   463,776,408 |              0 |              0 |              0 |            0 | 16,646,144 |
| Allocation Count            |          1 |      338,617 |  11,850,438 |    11,850,456 |        676,220 |        676,220 |        676,220 |      676,220 |  1,196,419 |
| Free Count                  |          0 |            0 |  11,511,821 |    11,511,838 |              0 |              0 |              0 |            0 |    520,199 |
| Process Time (ms)           |        645 |   39,208,790 |      13,265 |         7,958 |          3,786 |          3,222 |          2,941 |        2,809 |      3,995 |
| System Time (ms)            |        680 |   39,219,395 |      13,394 |         8,081 |          3,910 |          3,345 |          3,060 |        2,926 |      4,127 |
| Elapsed Time (ms)           |        680 |   39,209,008 |      13,390 |         8,076 |          3,909 |          3,343 |          3,058 |        2,925 |      4,125 |
...
| Words                       | 11,847,228 |   11,847,228 |  11,847,228 |    11,847,228 |     11,847,228 |     11,847,228 |     11,847,228 |   11,847,228 | 11,847,228 |
| Interned Words              |          0 |      337,601 |     337,601 |       337,601 |        337,601 |        337,601 |        337,601 |      337,601 |    337,601 |
| Currently Allocated (bytes) |          8 |   10,837,078 |  18,939,510 |    16,830,126 |     19,988,126 |     21,036,702 |     23,133,854 |   27,328,158 | 23,133,878 |
| Max Allocated Mem (bytes)   |          8 |   10,837,078 |  18,939,598 |    16,830,198 |     19,988,126 |     21,036,702 |     23,133,854 |   27,328,158 | 23,133,878 |
| Total Allocated Mem (bytes) |          8 |   10,837,078 | 663,568,981 |   480,597,085 |     19,988,126 |     21,036,702 |     23,133,854 |   27,328,158 | 39,780,022 |
| Total Freed Mem (bytes)     |          0 |            0 | 644,629,471 |   463,766,959 |              0 |              0 |              0 |            0 | 16,646,144 |
| Allocation Count            |          1 |      338,617 |  11,850,438 |    11,850,456 |        676,220 |        676,220 |        676,220 |      676,220 |  1,196,419 |
| Free Count                  |          0 |            0 |  11,511,821 |    11,511,838 |              0 |              0 |              0 |            0 |    520,199 |
| Process Time (ms)           |        675 |   36,146,387 |      12,240 |         6,293 |          3,844 |          3,241 |          2,943 |        2,755 |      3,688 |
| System Time (ms)            |        784 |   36,291,319 |      12,459 |         6,482 |          4,038 |          3,428 |          3,132 |        2,941 |      3,883 |
| Elapsed Time (ms)           |        774 |   36,181,673 |      12,406 |         6,448 |          4,006 |          3,401 |          3,103 |        2,916 |      3,852 |
...
| Currently Allocated (bytes) |          8 |              |  21,851,384 |    19,258,264 |     22,899,976 |     23,948,552 |     26,045,704 |   30,240,008 | 26,045,728 |
| Max Allocated Mem (bytes)   |          8 |              |  21,851,475 |    19,258,339 |     22,899,976 |     23,948,552 |     26,045,704 |   30,240,008 | 26,045,728 |
| Total Allocated Mem (bytes) |          8 |              | 758,821,533 |   574,800,861 |     22,899,976 |     23,948,552 |     26,045,704 |   30,240,008 | 42,691,872 |
| Total Freed Mem (bytes)     |          0 |              | 736,970,149 |   555,542,597 |              0 |              0 |              0 |            0 | 16,646,144 |
| Allocation Count            |          1 |              |  11,876,595 |    11,876,610 |        687,779 |        687,779 |        687,779 |      687,779 |  1,207,978 |
| Free Count                  |          0 |              |  11,526,419 |    11,526,433 |              0 |              0 |              0 |            0 |    520,199 |
| Process Time (ms)           |      3,240 |              |      35,258 |        11,350 |          9,751 |          8,784 |          8,137 |        7,832 |      8,294 |
| System Time (ms)            |      3,233 |              |      35,208 |        11,347 |          9,761 |          8,790 |          8,131 |        7,813 |      8,290 |
| Elapsed Time (ms)           |      3,240 |              |      35,262 |        11,351 |          9,752 |          8,785 |          8,137 |        7,833 |      8,295 |
